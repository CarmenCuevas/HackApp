class InvestorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @investor.save
        format.html { redirect_to @investor, notice: 'Se ha creado.' }
  ...
  def update
    respond_to do |format|
      if @investor.update(investor_params)
        format.html { redirect_to @investor, notice: 'Se ha actualizado' }
  ...
  def destroy
    @investor.destroy
    respond_to do |format|
      format.html { redirect_to investors_url, notice: 'Se ha destruido' }
  ...
  private
    ...
    def investor_params
      params.require(:investor).permit(:nombre, :edad, :perfil, :sector, :resultado, :latitud, :longitud)
    end
end
